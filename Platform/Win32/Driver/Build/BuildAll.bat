...
@echo ***********************************
call ddkcompile.bat %DDKPATH% fre x86 WLH
copy sys\objfre_wlh_x86\i386\psdrv3.sys  ..\Bin\x86
...
@echo *************************************
call ddkcompile.bat %DDKPATH% fre x64 WLH
copy sys\objfre_wlh_amd64\amd64\psdrv3.sys  ..\Bin\amd64
if "%ERRORLEVEL%" == "1" goto ErrorBuild
